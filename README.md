...
> 截图将在视觉流程稳定后补充到 `docs/images/`。

- 欢迎页：安静的星尘与电影片尾式排版
- 文字输入：1–80 字本地输入与字符粒子反馈
- 天体参数盘：能量、秩序、波动三个可访问控制器
- 生成转场：文字粒子采样、坍缩与星核出现
- 动态星云：Three.js 粒子、星核、轨道与触摸/鼠标交互
...
版本 `0.1.0` 目标为完整 MVP。真实进度见 [docs/PROGRESS.md](docs/PROGRESS.md)，
...
首版开发中；确认的问题会同步记录到 `docs/TODO.md` 与技术总结。
